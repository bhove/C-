    ...
    do {
        ...
        switch (chc) {
            ...
            case 4: sorthighlow (cnt, nums);
                    break;
            case 5: cout << "max = " << findhighest (cnt, nums) << endl;
                    break;
            case 6: cout << "min = " << findlowest (cnt, nums) << endl;
                    break;
        }
    } while (chc != 0);
...
int menu() {
    cout << endl;
    cout << "Enter 1 to review entered grades" << endl;
    cout << "Enter 2 to calculate the average" << endl;
    cout << "Enter 3 to sort the grades in ascending order" << endl;
    cout << "Enter 4 to sort the grades in descending order" << endl;
    cout << "Enter 5 for the highest entered grade" << endl;
    cout << "Enter 6 for the lowest entered grade" << endl;
...
void calcavg (int cnt, int nums[]) {
    ...
    cout << "avg = " << total / (double)cnt << endl;
}
